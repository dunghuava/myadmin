	 ...
	 <div class="row">
     	<div class="col-md-6">
             ...
             <div class="col-md-12 inline-flex">
                    ...
                    <input id="user_email" value="" type="text" name="user_email" class="form-control" required>
             </div>

             <div class="col-md-12 inline-flex">
                    <label for="">Tên đăng nhập</label>
                    <input id="user_name" value="" type="text" name="user_name" class="form-control" required>
                    <span id="result" style="color: red"></span>
             </div>

             <div class="col-md-12 inline-flex">
             	    <label for="">Mật khẩu</label>
     		        <input required id="user_password" type="text" name="user_password" class="form-control">
             </div>
